...
class NewprojectApp:
    def __init__(self, master=None):
        ...
        label2.configure(justify="left", text='Enter name')
        ...
        button1.place(
            ...
            x=0,
            y=0)
        button1.configure(command=self.greetme)
    ...
    def greetme(self):
        messagebox.showinfo("greeting", f"hi {self.myname.get()}")
